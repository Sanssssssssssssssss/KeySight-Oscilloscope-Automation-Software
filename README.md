...
The current default application entrypoint is the Qt client in `main.py`. The legacy Tk client is still available in `main_tk.py`.
...
Shared application defaults live in `configs/`:
